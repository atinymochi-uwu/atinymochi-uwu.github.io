...
<form action="" method="post">
   ...
   <input type="phone" name="number" required placeholder="Ingresa tu número de teléfono">
   ...
   <textarea name="address" placeholder="Ingresa tu dirección" id="" cols="30" rows="10"></textarea>
