...
<section class="shopping_cart">
  ...
  <div class="cart_box_cont">
    ...
    ?>
    <div class="cart_box">
      <a href="cart.php?delete=<?php echo $fetch_cart['id'];?>" class="fas fa-times" onclick="return confirm('¿Seguro que quieres borrar este item del carro?');"></a>
  ...
  <div class="cart_total">
    ...
    <div class="btns_cart">
    <a href="cart.php?delete_all" class="product_btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('¿Seguro que quieres borrar todos los items?');">Borrar todo</a>
      <a href="shop.php" class="product_btn">Seguir comprando</a>
